...
/**
 * 注意：父view中有实现了{@link NestedScrollingParent2}才会有嵌套滑动功能
 *
 ...
 */
public class NestedScrollWebView2 extends WebView implements NestedScrollingChild2, NestedScrollingParent {
    ...
    private void init() {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                mIsParentViewImplNestedScrolling = isParentViewImplNestedScrolling(NestedScrollWebView2.this);
            }
        });
    }
...
//                        }
    ...
    //判断是否有父view实现了NestedScrollingParent2
    public boolean isParentViewImplNestedScrolling(View view) {
        if (view instanceof NestedScrollingParent2) {
            return true;
        }
        if (view.getParent() != null && view.getParent() instanceof View) {
            return isParentViewImplNestedScrolling((View) view.getParent());
        } else {
            return false;
        }
    }
